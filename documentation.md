...
[AHKsock_Listen](#ahksock_listen)
[AHKsock_Connect](#ahksock_listen)
[AHKsock_Send](#ahksock_listen)
[AHKsock_ForceSend](#ahksock_listen)
[AHKsock_Close](#ahksock_listen)
[AHKsock_GetAddrInfo](#ahksock_listen)
[AHKsock_GetNameInfo](#ahksock_listen)
[AHKsock_SockOpt](#ahksock_listen)
[AHKsock_Settings](#ahksock_listen)
[AHKsock_ErrorHandler](#ahksock_listen)
[Notes on sockets and the structure of the event-handling function](#ahksock_listen)
[Notes on closing sockets and AHKsock_Close](#ahksock_listen)
[Notes on receiving and sending data](#ahksock_listen)
[Notes on testing a stream processor](#ahksock_listen)
